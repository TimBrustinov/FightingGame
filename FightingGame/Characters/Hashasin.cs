...
{
    public class Hashashin : Character
    {
        ...
        public Hashashin(CharacterName name, Texture2D texture) : base(name, texture)
        {
        ...
        {
            savedAnimaton = AnimationType.Dodge;
        ...
        protected override void Ability1()
        {
            (int, int) offsets = currFrame.GetWeaponHitboxOffsets();
            setWeaponHitbox(offsets.Item1, offsets.Item2, new Vector2(currFrame.AttackHitbox.Width, currFrame.AttackHitbox.Height));
            savedAnimaton = AnimationType.Ability1;
            if (animationManager.CurrentAnimation.IsAnimationDone && animationManager.lastAnimation == savedAnimaton)
            {
                savedAnimaton = AnimationType.None;
                currentAnimation = AnimationType.Stand;
        ...
        protected override void Ability2()
        {
            (int, int) offsets = currFrame.GetWeaponHitboxOffsets();
            setWeaponHitbox(offsets.Item1, offsets.Item2, new Vector2(currFrame.AttackHitbox.Width, currFrame.AttackHitbox.Height));
            savedAnimaton = AnimationType.Ability2;
            if (animationManager.CurrentAnimation.IsAnimationDone && animationManager.lastAnimation == savedAnimaton)
            {
                savedAnimaton = AnimationType.None;
                currentAnimation = AnimationType.Stand;
        ...
        protected override void Ability3()
        {
            (int, int) offsets = currFrame.GetWeaponHitboxOffsets();
            setWeaponHitbox(offsets.Item1, offsets.Item2, new Vector2(currFrame.AttackHitbox.Width, currFrame.AttackHitbox.Height));
            savedAnimaton = AnimationType.Ability3;
            if (animationManager.CurrentAnimation.IsAnimationDone && animationManager.lastAnimation == savedAnimaton)
            {
                savedAnimaton = AnimationType.None;
                currentAnimation = AnimationType.Stand;
