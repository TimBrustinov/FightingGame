...
namespace FightingGame
{
    public class Card : DrawableObjectBase
    {
        ...
        public Card(Texture2D texture, Rarity rarity, Color color, Action powerUp, Icon icon) : base(texture, new Vector2(0, 0), new Vector2(texture.Width * 0.5f, texture.Height * 0.5f), color)
        {
            PowerUp = powerUp;
            Rarity = rarity;
            Icon = icon;
